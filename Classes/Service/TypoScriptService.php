...
class TypoScriptService
{
     ...
     */
    public function getTypoScript(int $pageUid, ServerRequest $request, int $languageUid = 0, array $rootLine = [], SiteInterface $site = null): RootNode
    {
        ...
        if (count($rootLine) === 0) {
            ...
            $rootLine = self::getScopedRootline($site, $rootLine);
        }
        //
    ...
    protected static function getScopedRootline(SiteInterface $site, array $fullRootLine): array
    {
        if (!$site instanceof Site) {
            return $fullRootLine;
        }
