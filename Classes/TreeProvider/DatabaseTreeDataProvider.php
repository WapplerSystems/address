...
namespace WapplerSystems\Address\TreeProvider;
...
class DatabaseTreeDataProvider extends \TYPO3\CMS\Core\Tree\TableConfiguration\DatabaseTreeDataProvider
{
    ...
    /**
     * By setting "tx_address.singleCategoryAcl = 1" in UserTsConfig
    ...
    {
        if (is_array($GLOBALS['BE_USER']->userTS['tx_address.'])
            && $GLOBALS['BE_USER']->userTS['tx_address.']['singleCategoryAcl'] === '1'
        ) {
            return true;
        }
